        ...
        <View className="bg-white mt-3">
            ...
            {openPostOptions &&
                <View className="right-9 top-7 absolute rounded-md shadow-sm bg-white border border-gray-100 z-20">
                    <TouchableOpacity className="py-2.5 px-4 border-b border-gray-300"><Text className="text-gray-800">Chỉnh sửa</Text></TouchableOpacity>
                    <TouchableOpacity className="px-4 py-2.5"><Text className="text-gray-800">Xóa bài đăng</Text></TouchableOpacity>
                </View>
            }
